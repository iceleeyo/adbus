 ...
 */
public class Mail {
	public static Log log = LogFactory.getLog(Mail.class);
	String to = ""; // 收件人  
	String from = ""; // 发件人  
	String host = ""; // smtp主机  
	int port = 25;
	...
	public Mail(String to, String from, String host, String username, String password, String subject, String content) {
		this.to = to;
		this.from = from;
		this.host = host;
