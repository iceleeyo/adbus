...
menu="车身媒体"> <@frame.html title="车身媒体"
					...
					<DIV class="pg-guide-content">
						...
						<DIV class="pg-guide-info">
							<DIV class="pg-guide-item">
								<H4 class="h4bg-green">
									<SPAN>info图片广告介绍</SPAN>
								</H4>
								<DIV class="fn-clear">
									<DIV class="gridIn_6 alpha text-center">
										<IMG alt="人人贷理财12-14%的高收益" src="homepage/tem/info.png">
									</DIV>
									<DIV class="gridIn_6 omegaIn">
										<DL class="p20 pr40">
											...
											<DT>INFO图片：</DT>
											<DD>画面播放20秒为一个单位，每天滚动播出90次以上。</DD>
										</DL>
									</DIV>
								</DIV>
							</DIV>
