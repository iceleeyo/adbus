...
<@frame.html title="剩余时段比例" js=["js/highcharts/highcharts-3.0.2.js",
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<div class="tabs">
		<a id="tab1" href="${rc.contextPath}/report/day">剩余时段报表</a> <a
			...
			id="tab3" class="active" href="${rc.contextPath}/report/dayp">剩余时段比例</a>
		<a id="tab4" href="${rc.contextPath}/report/hourp">单日时段比例</a> <a
	...
	<div class="withdraw-title fn-clears">剩余时段比例</div>
	...
	seriesTypes=["TIMESLOT1", "TIMESLOT2", "TIMESLOT_PEAK1",
	"TIMESLOT_PEAK2"] />
</div>
</@frame.html>
