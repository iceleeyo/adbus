...
<div class="p20bs mt10 withdraw-wrap color-white-bg fn-clear"
	style="margin-left: 0px; margin-right: 120px">
		...
		<table id="table2" class="cell-border compact display" cellspacing="0"
			...
			<thead>
				<tr>
					...
					<th style="min-width: 80px;">线路名称</th> <@security.authorize
					ifAnyGranted="bodyFinancialManager,bodyContractManager,bodyScheduleManager">
					<th style="min-width: 80px;">上刊时间</th>
					<th style="min-width: 80px;">下刊时间</th> </@security.authorize>
					<th style="min-width: 80px;">施工时间</th>
					<th style="min-width: 80px;">是否确认</th> <@security.authorize
