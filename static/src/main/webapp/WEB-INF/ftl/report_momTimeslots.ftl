...
<@frame.html title="剩余时段月同比趋势图" js=["js/highcharts/highcharts-3.0.2.js",
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<div class="tabs">
		<a id="tab1" href="${rc.contextPath}/report/day">剩余时段报表</a> <a
			...
			class="active" href="${rc.contextPath}/report/mom">时段月同比</a>
	...
	<div style="margin-top: 20px;">
		...
		</select> <span class="ui-label-mini"> <input type="checkbox"
			name="baseY" id="baseY"<#if baseY?? && baseY ==
			0>checked</#if>>用0作为基线
		</span>
	</div>
	<div class="withdraw-title fn-clears">剩余时段月同比趋势图</div>
	...
	yName={"THIS_YEAR":"remain","PREV_YEAR":"remain"} titleY="剩余时长"
	highChart=remainTimeSlots baseY="${baseY!''}" seriesTypes=["THIS_YEAR",
	"PREV_YEAR"] />
</div>
</@frame.html>
