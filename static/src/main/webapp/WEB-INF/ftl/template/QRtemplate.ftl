...
<script type="text/javascript" language="javascript" src="${rc.contextPath}/js/jquery.dataTables-1.10.7.min.js"></script>
...
<body>
	...
	<#if city.mediaType == 'screen'> <#include "../menu/foot.ftl" /> </#if>
</body>
</html>
</#macro>
