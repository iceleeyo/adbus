...
<body>
	<div class="pg-header">
		<div class="pg-header-top"
			style="background: #5E637E; margin-top: 14px;">
				...
				<div class="grid-12 city-dropdown">
					<ul class="fl" style="margin-top: -14px">
						...
						<li class="dorpdown" id="ttbar-media">
							<div class="dt cw-icon ui-areamini-text-wrap" style="">
								<i class="ci-right"><s>◇</s></i> <#if city??> <a
									class="selected ui-areamini-text" data-id="${city.mediaType}"
									title="${city.mediaType.typeName}">车身广告</a> <#else> <a
									class="selected ui-areamini-text"
									data-id="${cities[0].mediaType!''}"
									title="${cities[0].mediaType.typeName!''}">车身广告</a> </#if>
							</div>
					</ul>
					<div class="s-right s-clear">
						<span class="pg-nav-item s-left" style="padding: 0;">您好，</span> <span>
							...
							href="${rc.contextPath}/order/myTask/1"> 我的账户:
						...
						<@security.authorize access="isAuthenticated()"> <a
							href="javascript:;" class="pg-nav-item s-left"
							onclick="logout();">[退出]</a> </@security.authorize>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container-index maincontent">
		<div class="broadcast s-clear">
			<div class="vediobox items s-left">
				...
				<div class="banner" id="b04">
					<ul>
						<li><img src="homepage/imgs/a01.png" alt="" width="1070"
							height="300"></li>
						<li><img src="homepage/imgs/a05.jpg" alt="" width="1070"
							height="300"></li>
						<li><img src="homepage/imgs/a04.jpg" alt="" width="1070"
							height="300"></li>
					</ul>
					<a href="javascript:void(0);" class="unslider-arrow04 prev"><img
						class="arrow" id="al" src="homepage/imgs/arrowl.png" alt="prev"
						width="20" height="35"></a> <a href="javascript:void(0);"
						class="unslider-arrow04 next"><img class="arrow" id="ar"
						src="homepage/imgs/arrowr.png" alt="next" width="20" height="37"></a>
				</div>

			</div>
			<div class="addition items s-left"></div>
		</div>
		<div class="container">
			...
			<div class="module1">
				...
				<div class="fn-clear pg-uplan-product-list text-middle mt15 mb10">
					...
					<div class="fn-left pg-uplan-product-item mr15">
						<a href="javascript:;"
							onclick="showSite('${rc.contextPath}/api/public_lineMap?lineName=${item.line.name}');">
							<dl class="bg-color-white">
								<dt class="ub" style="height: 310px;">
									<div>
										<span class="mr10" style="font-size: 16px;">线路名 <font
											color="#2ea7e0">${item.line.name!''}</font>
										</span>
									</div>
									<div style="margin: -15px 2px 0px 0px;">
										<span class="mr10" style="font-size: 12px;">线路级别:
											${item.line.levelStr!''} </span>
									</div>
									<div style="margin: -15px 2px 0px 0px;">
										<span class="mr10" style="font-size: 12px;">车辆数:
											${item.line._cars!''} </span>
									</div>
									<div style="margin: -15px 2px 0px 0px;">
										<span class="mr10" style="font-size: 12px;">人车流量:
											${item.line._persons!''} </span>
									</div>

									<div class="img_box" style="width: 100%; height: 170px;">
										<img class="img_size" src="${rc.contextPath}${item.impSite}"
											onmouseenter="changeImg('${rc.contextPath}','${item.impSite}',this)"
			...
			<div class="module1"><#include "index_mapLines.ftl" /></div>
		...
		<div class="qqbox">
			<dl>
				...
				<dd>
					客服a:<a target="_blank"
						href="http://wpa.qq.com/msgrd?v=3&uin=3271689631&site=qq&menu=yes"><img
						border="0" width="70" src="http://wpa.qq.com/pa?p=2:3271689631:41"
						alt="点击这里给我发消息" title="点击这里给我发消息" /></a>
				</dd>
				<dd>
					客服b:<a target="_blank"
						href="http://wpa.qq.com/msgrd?v=3&uin=2799461911&site=qq&menu=yes"><img
						border="0" width="70" src="http://wpa.qq.com/pa?p=2:2799461911:41"
						alt="点击这里给我发消息" title="点击这里给我发消息" /></a>
				</dd>
				<dd>
					销售a:<a class="qq-default"></a>
				</dd>
				<dd>
					销售b:<a class="qq-default"></a>
				</dd>
