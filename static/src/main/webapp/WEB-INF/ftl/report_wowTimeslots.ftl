...
<@frame.html title="剩余时段周同比趋势图" js=["js/highcharts/highcharts-3.0.2.js",
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<div class="tabs">
		<a id="tab1" href="${rc.contextPath}/report/day">剩余时段报表</a> <a
			...
			id="tab6" class="active" href="${rc.contextPath}/report/wow">时段两周同比</a>
	...
	<div class="withdraw-title fn-clears">剩余时段周同比趋势图</div>
	...
	yName={"THIS_WEEK":"remain","PREV_WEEK":"remain"} titleY="剩余时长"
	highChart=remainTimeSlots baseY="${baseY!''}" seriesTypes=["THIS_WEEK",
	"PREV_WEEK"] />
</div>
</@frame.html>
