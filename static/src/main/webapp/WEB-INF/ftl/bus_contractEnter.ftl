<#import "template/template.ftl" as frame> <#global menu="车辆关联合同">
<@frame.html title="车辆关联合同" js=["js/jquery-ui/jquery-ui.js",
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<form data-name="withdraw" name="userForm2" id="userForm2"
		...
		<div class="withdraw-title fn-clear">车辆关联合同</div>
		<div class="withdrawInputs">
			<div class="inputs">
				<div class="ui-form-item">
					<label class="ui-label mt10"><span class="ui-form-required">*</span>车牌号:</label>
					<input class="ui-input validate[required]" type="text" value=""
						id="plateNumber" data-is="isAmount isEnough" autocomplete="off"
						disableautocomplete="">
					<p class="ui-term-placeholder" placeholder="车牌号可写多个用逗号分隔"></p>

				</div>
				<div class="ui-form-item">
					<label class="ui-label mt10"><span class="ui-form-required">*</span>合同:</label>
