		...
		<div class="withdrawInputs" style="margin-left: 10px;">
			<div class="inputs">
				...
				<div id="other">
					...
					<div class="ui-form-item">
						<label class="ui-label mt10"><span
							class="ui-form-required">*</span>邮寄地址:</label> <input
					...
					<div class="ui-form-item">
						<label class="ui-label mt10"><span
							class="ui-form-required">*</span>税务登记复印件: <#if invoiceView?? >
							<#list invoiceView.files as item> <#if item?has_content &&
							item.type==7> <a
							href="${rc.contextPath}/downloadFile/${item.userId!''}/${item.id!''}">
								${item.name!''}</a> &nbsp;&nbsp; &nbsp; </#if> </#list> </label><br>
