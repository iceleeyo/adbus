...
<@frame.html title="单日时段比例" js=["js/highcharts/highcharts-3.0.2.js",
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<div class="tabs">
		<a id="tab1" href="${rc.contextPath}/report/day">剩余时段趋势</a> <a
			id="tab2" href="${rc.contextPath}/report/hour">三天时段报表</a> <a
			id="tab3" href="${rc.contextPath}/report/dayp">剩余时段比例</a> <a
			id="tab4" class="active" href="${rc.contextPath}/report/hourp">单日时段比例</a>
		<a id="tab5" href="${rc.contextPath}/report/monthp">全年时段比例</a> <a
	...
	<div class="withdraw-title fn-clears">单日时段比例</div>
	...
	yName={"TIMESLOT1":"remain","TIMESLOT2":"ordered"} titleY="剩余时长"
	highChart=remainTimeSlots baseY="${baseY!''}" seriesTypes=["TIMESLOT1",
	"TIMESLOT2"] />
</div>
</@frame.html>
