...
<@frame.html title="底片录入" js=["js/jquery-ui/jquery-ui.js",
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<form data-name="withdraw" name="userForm2" id="userForm2"
		...
		action="${rc.contextPath}/contract/saveblackAd?dos_authorize_token=b157f4ea25e968b0e3d646ef10ff6624&t=v1"
		enctype="multipart/form-data">
		<div class="withdraw-title fn-clear">底片录入</div>
			...
			<div class="inputs">
				<div class="ui-form-item">
					...
					<input
						...
						type="text" name="adName" value="" id="name"
				...
				<div class="ui-form-item">
					...
					<input
						class="ui-input validate[required,custom[noSpecialLetterChinese],minSize[5],maxSize[120]]"
						type="text" name="seqNumber" value="" id="name"
						data-is="isAmount isEnough" autocomplete="off"
						disableautocomplete="">
					<p class="ui-term-placeholder" placeholder="中英文、数字、下划线"></p>
				</div>
				...
				<div class="ui-form-item">
					<label class="ui-label mt10"><span class="ui-form-required">*</span>时长:</label>
					<input class="ui-input validate[required,integer,min[5],max[180]]"
						onkeyup="value=value.replace(/[^\d]/g,'')" value="15"
						name="duration" id="duration" data-is="isAmount isEnough"
						autocomplete="off" disableautocomplete="" placeholder="5-180秒">
				</div>
				<div class="ui-form-item">
					<label class="ui-label mt10"> <span
						class="ui-form-required">* </span>权重:
					</label> <select data-is="isAmount isEnough" id="sortNumber"
						name="sortNumber" autocomplete="off" disableautocomplete=""
