<#import "template/template.ftl" as frame> <#global menu="车身套餐定义">
<@frame.html title="车身套餐定义"
...
<div id="relateSup">
	<div class="p20bs mt10 color-white-bg border-ec">
		<div class="withdraw-title fn-clear">添加套餐方案</div>
		<form data-name="withdraw" name="form1" id="form1" class="ui-form"
			method="post" action="${rc.contextPath}/product/saveBusOrderDetail"
				...
				<div class="inputs">
					<div class="ui-form-item ">
						<label class="ui-label mt10"><span
							class="ui-form-required">*</span>线路级别：</label> <select class="ui-input"
					...
					<div class="ui-form-item ">
						<label class="ui-label mt10"><span
							class="ui-form-required">*</span>车型:</label> <select class="ui-input"
							name="doubleDecker" id="lineLevel">
					...
					<div class="ui-form-item">
						<label class="ui-label mt10"><span
							class="ui-form-required">*</span>巴士数量:</label> <input
							class="ui-input validate[required,number,min[1]" type="number"
							value="" name="busNumber" id="busNumber"
							data-is="isAmount isEnough" autocomplete="off"
							disableautocomplete="">
					</div>
					<div class="ui-form-item toggle bodyToggle">
						<label class="ui-label mt10"><span
							class="ui-form-required">*</span>刊期:</label> <select class="ui-input"
							name="days">
...
<div class="p20bs mt10 color-white-bg border-ec">
	...
	<div id="orderedBuses">
		<table id="table" class="display compact" cellspacing="0" width="70%">
			<thead>
				<tr class="tableTr">
					<th>线路级别</th>
					<th>车型</th>
	...
	<form data-name="withdraw" name="form2" id="form2" class="ui-form"
		...
		<div class="withdrawInputs">
			<div class="ui-form-item toggle bodyToggle">
				...
				<input type="text" value="0" name="price" id="sumprice"
...
<div class="ui-form-item widthdrawBtBox"
	...
	<input type="button" id="subutton" class="block-btn" onclick="sub();"
		value="生成套餐">
</div>
</div>
</form>
