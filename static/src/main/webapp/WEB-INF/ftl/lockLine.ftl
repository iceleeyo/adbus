	...
	<div class="p20bs mt10 color-white-bg border-ec">
		<div class="withdraw-title">
			<span>（一）发布线路信息</span> <input type="hidden" name="seriaNum"
				...
				onclick="addBatch('${rc.contextPath}',${seriaNum})">增加批次</a> 
		</div>
		<div id="orderedBuses">
				...
				<div class="withdrawInputs">
					<div class="inputs">
						...
						<div class="ui-form-item">
							<label class="ui-label mt10"> 营销中心:
							</label> <input class="ui-input validate[required]" type="text"
								name="contractCode" value="${(offlinecontract.markcenter)!''}"
								data-is="isAmount isEnough" autocomplete="off"
								disableautocomplete="" placeholder="请输入合同编号">
						</div>
						<div class="ui-form-item">
							<label class="ui-label mt10"> 合同编号:
							</label> <input class="ui-input validate[required]" type="text"
						...
						<div class="ui-form-item">
							<label class="ui-label mt10">客户名称:</label> <input
						...
						<div class="ui-form-item">
							<label class="ui-label mt10">联系人:</label> <input
						...
						<div class="ui-form-item">
							<label class="ui-label mt10"> 广告内容:
							</label> <input class="ui-input validate[required]" type="text"
