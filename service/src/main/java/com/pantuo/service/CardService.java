...
public interface CardService {
	...
	public Pair<Boolean, String> payment(String startdate1,String paytype,int isdiv, String divid, long seriaNum, Principal principal, int city, String meids, String boids);
