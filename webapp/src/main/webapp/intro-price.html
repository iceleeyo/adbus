...
<head>
  ...
  <META http-equiv="X-UA-Compatible" content="IE=edge"> <TITLE>新手指引</TITLE> 
		...
		<div class="header-content">
			<div class="container-12 s-clear">
				...
				<div class="show-item s-right">
					...
					<a href="intro-price.html" class="selected">产品促销</a>
...
<H4 class="h4bg-yellow"><SPAN>广告刊例</SPAN></H4>
<DIV class="fn-clear">
<DIV class="grid_6 alpha text-center performance">
<DIV class="pl100"><IMG alt="广告刊例" src="homepage/tem/advert_example.png">             
             </DIV></DIV></DIV>
</DIV>
			</DIV>   
		</DIV>
