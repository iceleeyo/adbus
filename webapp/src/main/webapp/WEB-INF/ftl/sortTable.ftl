...
$("#table tbody").sortable({
    ...
    stop: updateIndex
            ...
            <table id="sort"  class="display compact" cellspacing="0" width="100%" title="Kurt Vonnegut novels">
    <thead>
        <tr><th class="index">No.</th><th>Year</th><th>Title</th><th>Grade</th></tr>
    </thead>
    <tbody>
        <tr id="1969"><td class="index">1</td><td>1969</td><td>Slaughterhouse-Five</td><td>A+</td></tr>
        <tr id="1952"><td class="index">2</td><td>1952</td><td>Player Piano</td><td>B</td></tr>
        <tr id="1963"><td class="index">3</td><td>1963</td><td>Cat's Cradle</td><td>A+</td></tr>
        <tr id="1973"><td class="index">4</td><td>1973</td><td>Breakfast of Champions</td><td>C</td></tr>
        <tr id="1965"><td class="index">5</td><td>1965</td><td>God Bless You, Mr. Rosewater</td><td>A</td></tr>
    </tbody>
</table>
<script type="text/javascript">
var fixHelperModified = function(e, tr) {
