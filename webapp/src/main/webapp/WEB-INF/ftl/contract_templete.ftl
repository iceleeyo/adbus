...
<body class="b1 b2">
	...
	<p class="p2">
		...
		<tr>
			<td COLSPAN="2" width="25%">广告/节目内容名称</td><td COLSPAN=2 width="25%"></td>
			<td COLSPAN="2" width="25%">发布时间/刊期</td><td COLSPAN=2 width="25%"></td>
		</tr>
		<tr>
	...
	<p class="p7">
		<span class="s7">3. &nbsp;</span><span>广告/节目发布后，由乙方出具《刊播报告》及回执。甲方接到乙方出具的《刊播报告》后，及时将《刊播报告》回执盖章并签字送达乙方。</span>
	</p>
	<p class="p7">
		<span class="s7">4. &nbsp;</span><span>本合同在末页及骑缝处加盖双方合同专用章，一式肆份，甲乙双方各执贰份，具有同等的法律效力，自双方签字盖章之日起生效。</span><a
