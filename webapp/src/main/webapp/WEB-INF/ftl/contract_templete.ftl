...
<body class="b1 b2">
	...
	<p class="p7">
		<span class="s7">2. &nbsp;</span><span>付款时间及进度：采取甲方先付款的形式，甲方款项应按合同约定按期支付给乙方，到帐后乙方依约给予安排播出。</span>
	</p>
	<p class="p9">
		<span class="s9">3. &nbsp;</span><span class="s2">甲方应当确保</span><span>广告/节目</span><span
			class="s2">食品的卫生和品质，且提供的资料、素材应符合国家及北京市的政策导向和宣传要求，否则，乙方有权拒绝制作/播出。乙方同意制作/播出的，并不能作为免除或者减轻甲方责任的依据。</span>
	</p>
	<p class="p9">
		<span class="s9">4. &nbsp;</span><span class="s2">甲方对于</span><span>广告/节目</span><span
