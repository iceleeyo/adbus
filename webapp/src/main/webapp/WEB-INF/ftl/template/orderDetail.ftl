...
<DIV class="p20bs color-white-bg border-ec">
 ...
 <#if orderview.closed>
  <li style="width: 720px;"><SPAN> 关闭原因：</SPAN><SPAN class="con"><a class="layer-tips" tip="点击可查关闭内容!" onclick="showRemark('${orderview.order.closeRemark!''}');"  >${substring(orderview.order.closeRemark,0,38)}</a></SPAN></li>
    			  ...
    			  <li class="s-left f-iconli"><span class="s-left tt"><i class="s-left fff-icon"></i>支付及发票</span></li>
				  ...
				  <li class="s-left f-iconli"><span class="s-left tt"><i class="s-left fff-icon"></i>物料及资质</span></li>
				  ...
				  <li class="s-left f-iconli"><span class="s-left tt"><i class="s-left fff-icon"></i>排期信息</span></li>
