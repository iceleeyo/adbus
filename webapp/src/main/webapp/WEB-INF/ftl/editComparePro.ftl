...
<div class="withdraw-wrap color-white-bg fn-clear">
	<form data-name="withdraw" name="productForm" id="productForm"
		class="ui-form" method="post" action="${rc.contextPath}/product/saveCompareProduct"
			...
			<div class="inputs" style="padding-left: 20px;">
				<div class="ui-form-item">
					...
					<select class="ui-input" name="type" id="type"> <#list
						types as type>
						<option value="${type.name()}"<#if (prod.product?? && prod.product.type
				...
				<div class="ui-form-item">
					...
					<input
						...
						type="text" value="<#if prod.product??>${prod.product.name!''}<#else></#if>"
				...
				<div class="ui-form-item ">
					<label class="ui-label mt10"><span class="ui-form-required">*</span>
						...
						onkeyup="value=value.replace(/[^\d.]/g,'')"
						value="<#if prod.product??>${prod.product.days!''}<#else>7</#if>" name="days"
					...
					<div class="ui-form-item">
						<label class="ui-label mt10"><span
							...
							type="text" name="startDate1" id="startDate1" value="${prod.startDate?string("yyyy-MM-dd HH:mm:ss ")}"
