...
<@frame.html title="到期提示" js=["js/jquery-ui/jquery-ui.js","js/jquery-dateFormat.js",
...
<div class="withdraw-wrap color-white-bg fn-clear">
            ...
            <span> 起：<input  class="datepicker" type="text"  id="end1" data-is="isAmount isEnough" autocomplete="off" disableautocomplete=""> </span>&nbsp;&nbsp; 
            <span> 止：<input  class="datepicker" type="text"  id="end2" data-is="isAmount isEnough" autocomplete="off" disableautocomplete=""> </span>&nbsp;&nbsp; 
            </div>   
