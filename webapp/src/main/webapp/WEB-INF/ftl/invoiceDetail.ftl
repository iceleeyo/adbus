<#import "template/template.ftl" as frame> <@frame.html title="发票详细"
	...
	<DIV class="summary mt10 uplan-summary-div">
		<UL class="uplan-detail-ul">
			...
			<LI style="width: 720px;"><SPAN>附件：</SPAN><SPAN class="con">
					<#if invoiceView.files?has_content> <#list invoiceView.files as
					item> <a
