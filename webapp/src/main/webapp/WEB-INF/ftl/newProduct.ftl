		...
		<div class="withdrawInputs">
			<div class="inputs" style="padding-left: 20px;">
				...
				<div class="ui-form-item" id="file">
					...
					<div id="newUpload2">
						<#if prod.imgurl?has_content > <input type="hidden" name="imgurl"
							value="${prod.imgurl}" /> <img
							src="${rc.contextPath}/upload_temp/${prod.imgurl}" class="m11"
				...
				<input type="hidden" name="id" value="${prod.id}" /> <#else>
				<div class="ui-form-item" id="file">
				...
				<div class="ui-form-item">
					...
					线路概况&nbsp;&nbsp;<input style="width:250px;" id="exclusiveUser" name="linesurvey" value="<#if jsonView??>${jsonView.linesurvey!''}</#if>" placeholder="例如：北京六环内
                                      470余条公交线路" >&nbsp;&nbsp;&nbsp;&nbsp;
