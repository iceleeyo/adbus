...
<@frame.html title="商品sift" left=false nav=false js=["js/sift_bus.js","js/jquery-ui/jquery-ui.js", "js/datepicker.js", "js/jquery.datepicker.region.cn.js"] css=["css/sift.css","css/account.css","js/jquery-ui/jquery-ui.css"]>
<head> 
						...
						<div class="sift-box">
							...
							<div class="sift-item s-clear">
								...
								<div class="sift-list" qt="lev">
									...
									<a class="item" href="#"  sort="-1" qc="LATLONG" >经纬线<i>×</i></a>
								</div>
							</div>
							<div class="sift-item s-clear">
								<span>车型类型：</span>
							...
							<div class="sift-item s-clear">
								...
								<div class="sift-list" qt="d">
									<a class="item" href="#" sort="-1" qc="2" >30<i>×</i></a>
									<a class="item" href="#" sort="-1" qc="3">60<i>×</i></a>
									<a class="item" href="#" sort="-1" qc="4">90<i>×</i></a>
									<a class="item" href="#" sort="-1" qc="5">180<i>×</i></a>
									<a class="item" href="#" sort="-1" qc="5">360<i>×</i></a>
								</div>
							</div>
