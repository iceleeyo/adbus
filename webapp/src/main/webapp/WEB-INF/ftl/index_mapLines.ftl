...
<@frame.html title="线路列表" js=["${rc.contextPath}/js/jquery-dateFormat.min.js","${rc.contextPath}/js/jquery-ui/jquery-ui.js",
"${rc.contextPath}/js/jquery-ui/jquery-ui.auto.complete.js"] 
