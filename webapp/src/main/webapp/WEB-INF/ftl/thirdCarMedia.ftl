				...
				<div class="third-step">
					<div class="detail">
						<div class="detail-bd clearfix">
							<div class="d-left">
								<img src="${rc.contextPath}/index_img/jj-2.png" width="345" height="345">
								<div class="sm-imgs">
									<img id="ima" src="${rc.contextPath}/index_img/jj-2.png" height="65" width="65">
									<img src="${rc.contextPath}/index_img/jj-3.png" height="65" width="65">
									<img src="${rc.contextPath}/index_img/jj-3.png" height="65" width="65">
								</div>
