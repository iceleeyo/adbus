					...
					<div class="slider view1">
						<div class="view-text">
							<div class="right">
								...
								<div class="mid">
									以德行立足于世，我们用最高的行业标准要求自己<br>
									<br> 用能力打造品牌，每一份产品都源自不断地构想与实践<br>
									<br> 漫漫征途，只为远方<br>
									<br> 不畏险阻，一路同行
								</div>
							</div>
					...
					<div class="slider view2">
						<div class="view-text">
							<div class="mid">
								...
								<br>
								<br>世巴传媒电商平台经营内容包括北京全市公交车载电视媒体、电子站牌、场站信息服务显示屏等，依托公交车载移动电视实现北京市区全覆盖的优势，推出栏目植入广告业务，为客户专门定制节目，为客户提供专业、优质的服务。
								<br>
								<br>平台遵循先进的O2O理念，大胆创新公交媒体营销模式，将互联网思维运用到传统交易中，将线上交易于线下体验相结合，更加方便用户使用，注重用户体验。
