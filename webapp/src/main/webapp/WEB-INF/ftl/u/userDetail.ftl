...
<#global menu="用户详情">
<@frame.html title="用户详情" js=["js/jquery-ui/jquery-ui.js", "js/datepicker.js", "js/jquery.datepicker.region.cn.js"] css=["js/jquery-ui/jquery-ui.css"]>
...
<div class="withdraw-wrap color-white-bg fn-clear">
            ...
            --><button type="button" onclick="go_back()" class="block-btn" style="margin-left: 20px;">返回</button>
								</div>
								<div class="withdrawInputs">
									<div class="inputs">
                                        ...
                                        <div class="ui-form-item">
                                            <label class="ui-label mt10">邮箱地址:</label>
                                                    <input readonly="readonly"
												class="ui-input" type="text" name="email"
												id="amounts" data-is="isAmount isEnough"
												autocomplete="off" disableautocomplete="" value="${userDetail.user.email!''}">
                                        </div>
                                        ...
                                        <div class="ui-form-item">
                                            <label class="ui-label mt10">联系电话:</label>
												...
												id="amounts" data-is="isAmount isEnough"
												autocomplete="off" disableautocomplete="" value="${userDetail.phone!''}">
                                        </div>
                                        ...
                                        <div class="ui-form-item">
                                            <label class="ui-label mt10">所属公司:</label>
												...
												id="amounts" data-is="isAmount isEnough"
												autocomplete="off" disableautocomplete="" value="${userDetail.company!''}">
                                        </div>
