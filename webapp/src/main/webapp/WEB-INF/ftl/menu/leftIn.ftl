							...
							<div class="pg-side">
								<ul class="pg-side-list">
									<li class="pg-side-item">
										<a class="pg-side-item-t aa-icon" href="${rc.contextPath}/intro-video">
									...
									<li class="pg-side-item">
										<a class="pg-side-item-t cc-icon" href="${rc.contextPath}/intro-ywzn">
									...
									<li class="pg-side-item">
										<a class="pg-side-item-t dd-icon" href="${rc.contextPath}/about-me">
