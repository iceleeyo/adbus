...
<@frame.html title="剩余时段趋势图" js=["js/highcharts/highcharts-3.0.2.js",
...
<script type="text/javascript">
        $(function(){
            ...
            $("#day, #baseY").change(function() {
                $(location).attr('href', "day?day=" + $("#day").val()
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<div class="tabs">
		<a id="tab1" class="active" href="${rc.contextPath}/report/day">剩余时段报表</a>
		<a id="tab2" href="${rc.contextPath}/report/hour">三天时段报表</a> <a
	...
	<div class="withdraw-title fn-clears">剩余时段趋势图</div>
	...
	yName={"TIMESLOT":"remain","TIMESLOT_PEAK":"remain"} titleY="剩余时长"
	highChart=remainTimeSlots baseY="${baseY!''}" seriesTypes=["TIMESLOT",
	"TIMESLOT_PEAK"] />
</div>
</@frame.html>
