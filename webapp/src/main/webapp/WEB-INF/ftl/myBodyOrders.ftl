...
var table;
    function initTable () {
        table = $('#table').dataTable( {
            ...
            "ajax": {
                type: "GET",
                url: "${rc.contextPath}/busselect/ajax-myOrders",
                data: function(d) {
                    return $.extend( {}, d, {
...
<div class="withdraw-wrap color-white-bg fn-clear">
	...
	<div class="tabs">
		<@security.authorize ifAnyGranted="bodysales"> <#if orderMenu=="我的订单">
		<a id="tab1" href="${rc.contextPath}/busselect/myOrders/1"
			class="active">${orderMenu}<span id="recordsTotal"
			style="background-color: #ff9966; font-size: 14px; border-radius: 4px;"></span></a>
		<#else> <a id="tab1" href="${rc.contextPath}/busselect/myOrders/1">${orderMenu}</span></a>
		...
		<a id="tab2" href="${rc.contextPath}/busselect/body_allRuningOrders">进行中的订单</a>
			...
			href="${rc.contextPath}/busselect/finished">已完成的订单</a>
		<@security.authorize
		ifAnyGranted="bodyContractManager,bodyFinancialManager,bodyScheduleManager">
		<#if orderMenu=="我参与订单"> <a id="tab4" class="active"
			href="${rc.contextPath}/busselect/join/1">我参与的订单<span
			id="recordsTotal"
			style="background-color: #ff9966; font-size: 14px; border-radius: 4px;"></span></a>
		<#else> <a id="tab4" href="${rc.contextPath}/busselect/join/1">我参与的订单<span
			id="recordsTotal"
			style="background-color: #ff9966; font-size: 14px; border-radius: 4px;"></span></a>
