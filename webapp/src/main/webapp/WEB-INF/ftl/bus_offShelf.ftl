<#import "template/template.ftl" as frame> <#global menu="车辆下刊">
<#assign security=JspTaglibs["/WEB-INF/tlds/security.tld"] />
<@frame.html title="车辆下刊"
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<div class="withdraw-title">车辆下刊</div>
	<div>
		<span style="margin-left: 5px;">下刊日期：</span> <span> <input
			class="datepicker" type="text" name="offday" id="offday"
			data-is="isAmount isEnough" autocomplete="off" disableautocomplete="">
		</span>&nbsp;&nbsp; <input type="button" class="button_kind"
			style="width: 85px;" value="批量下刊" onclick="batchOff()" />
	</div>
