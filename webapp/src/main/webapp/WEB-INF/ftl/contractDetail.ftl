...
<div class="withdrawB-wrap color-white-bg fn-clear"
	...
	<form data-name="withdraw" name="userForm2" id="userForm2"
		...
		<H3 class="text-xl title-box">
			<A class="black" href="#">合同详情【${(view.mainView.contractName)!''}】</A>
		</H3>
		<DIV class="summary mt10 uplan-summary-div">
			<UL class="uplan-detail-ul">
				...
				<LI style="width: 240px;"><SPAN>合同名称：</SPAN><SPAN class="con"
					style="color: rgb(245, 135, 8);">${(view.mainView.contractName)!''}</SPAN></LI>
				...
				<LI style="width: 240px;"><SPAN>金额（人民币：元）：</SPAN><SPAN
					class="con">${(view.mainView.amounts)!''}</SPAN></LI>
