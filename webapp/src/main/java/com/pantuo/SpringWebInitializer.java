...
public class SpringWebInitializer extends AbstractAnnotationConfigDispatcherServletInitializer implements WebApplicationInitializer {
    ...
    protected Class[] getRootConfigClasses() {
        return new Class[] { DaoBeanConfiguration.class, WebAppConfiguration.class, SecurityConfiguration.class, CacheConfiguration.class, SchedulerConfiguration.class };
    }
